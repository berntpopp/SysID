 ...
 * @property string $user_institution_name
...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['user_name'], 'unique', 'message' => 'This username has already been taken.'],
            ['user_name', 'filter', 'filter' => 'trim'],
            ['user_designation', 'string', 'max' => 45],            
            ['user_institution_name', 'string', 'max' => 255],            
            ['user_email', 'filter', 'filter' => 'trim'],            
            ['user_email', 'email'],
            ['user_email', 'unique', 'message' => 'This email address has already been taken.'],
            ['status', 'safe'],
            ['user_role', 'safe'],
            ['user_remark', 'safe'],
        ];
    ...
    public static function findByPasswordResetToken($token)
    {
        ...
        $test = static::findOne([ 'password_reset_token' => $token, 'status' => self::STATUS_ACTIVE,]);
